...
date: 2018-07-03
categories: [rstats, curiosity-project, questionflow]
...
::: {.callout-note title="Code for Elo model" collapse="true"}
```r
...
::: {.callout-note title="Code for EloBeta model" collapse="true"}
```r
...
::: {.callout-note title="Code for data creation" collapse="true"}
```r
...
::: {.callout-note title="Code for methodology functions" collapse="true"}
```r
...
::: {.callout-note title="Code for doing experiment" collapse="true"}
```r
...
::: {.callout-note title="Code for producing results of experiment" collapse="true"}
```r
...
![](2018-07-03-elo-and-elobeta-models-in-snooker/experiment-results.png)
...
::: {.callout-note title="Code for 2017/18 top 16" collapse="true"}
```r
# Helper function
...
::: {.callout-note title="Code for rating evolution" collapse="true"}
```r
# Helper data
...
![](2018-07-03-elo-and-elobeta-models-in-snooker/rating-evolution_all.png)

## Evolution of EloBeta top 16

::: {.callout-note title="Code for rating evolution of top 16" collapse="true"}
```r
# Compute plot data
...
![](2018-07-03-elo-and-elobeta-models-in-snooker/rating-evolution_top16.png)
