...
date: 2020-05-11
categories: [python, curiosity-project, questionflow]
...
This post consists from two parts (if you just want to know a total count, skip right to [Epilogue](#epilogue)):
