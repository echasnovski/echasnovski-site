...
date: 2018-06-14
categories: [rstats, tidyverse, tweenr]
...
::: {.callout-note title="Code for setup" collapse="true"}
```r
...
::: {.callout-note title="Code for data generation" collapse="true"}
```r
...
::: {.callout-note title="Code for computing plotting data" collapse="true"}
```r
...
::: {.callout-note title="Code for creating static plots" collapse="true"}
```r
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/example plots-1.png)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/example plots-2.png)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/example plots-3.png)
...
::: {.callout-note title="Code for creating transitions" collapse="true"}
```r
...
::: {.callout-note title="Code for creating animation" collapse="true"}
```r
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/animation_1.gif)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/animation_2.gif)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/animation_3.gif)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/animation_4.gif)
...
![](2018-06-14-animating-mode-variability-with-tidyverse-and-tweenr/accidental-art-1.png)
